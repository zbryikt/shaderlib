...
var ShaderRenderer, slice$ = [].slice;
...
ShaderRenderer.prototype = import$(Object.create(Object.prototype), {
  ...
  makeProgram: function(shader, pprogram){
    ...
    vs = this.makeShader(shader.vertexShader, gl.VERTEX_SHADER);
    fs = this.makeShader(shader.fragmentShader, gl.FRAGMENT_SHADER);
  ...
  render: function(t){
    var gl, i$, to$, i, ref$, pdata, pobj, shader, uTime, k, v, u, results$ = [];
    t == null && (t = 0);
    if (!this.inited) {
      this.init();
    }
